...
class HybridQNN(nn.Module):
    def __init__(self):
        ...
        self.relu = nn.ReLU()
        self.classical_layer2 = nn.Linear(4, 1)
...
optimizer = optim.Adam(model.parameters(), lr=0.05)  # Aumentar la tasa de aprendizaje para una convergencia más rápida

# 7. Entrenar la QNN híbrida
n_epochs = 100  # Aumentar el número de épocas
losses = []
