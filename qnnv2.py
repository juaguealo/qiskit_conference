...
# En este caso usaremos el conjunto Iris
# ---------------------------------
...
weight_params = ParameterVector('weight', 8)  # Parámetros de pesos con 8 parámetros (2 por qubit)

# Crear un circuito cuántico simple con entrelazamiento
...
# Convertir las predicciones en valores binarios para clasificación (aproximación)
y_test_pred = torch.round(y_test_pred)  # Aproximamos la salida a 0 o 1
y_test_pred = y_test_pred.detach().numpy()

# Convertir las etiquetas y las predicciones a enteros
